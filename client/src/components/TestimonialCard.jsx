    ...
    return (
        <div className={`group glass-card p-4 sm:p-6 hover:border-${gradient}-500/30 transition-all duration-300 relative overflow-hidden h-full`}>
            ...
            <div className="relative flex flex-col h-full">
                ...
                {/* Testimonial Text */}
                <p className="text-xs sm:text-sm md:text-base text-surface-600 leading-relaxed mb-4 sm:mb-6 flex-grow">
                    "{testimonial.text}"
                </p>
                ...
                <div className="flex items-center gap-3 mt-auto">
                    ...
                    <div>
                        <h4 className="text-sm sm:text-base font-semibold text-surface-800">{testimonial.name}</h4>
