...
export function Skeleton({ className = '', animate = true }) {
    return (
        <div
            className={`bg-surface-200/80 rounded ${animate ? 'animate-shimmer' : ''} ${className}`}
            style={{
...
export function SkeletonStatCard({ className = '' }) {
    return (
        <div className={`bg-surface-100/80 backdrop-blur-sm rounded-lg sm:rounded-xl lg:rounded-2xl p-2.5 sm:p-4 lg:p-6 border border-surface-200/50 ${className}`}>
...
export function SkeletonInterviewCard({ className = '' }) {
    return (
        <div className={`flex items-center justify-between p-2 sm:p-3 bg-surface-200/50 rounded-lg ${className}`}>
    ...
    return (
        <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            <div className="grid gap-3 sm:gap-4 lg:gap-6 lg:grid-cols-3">
                ...
                <div className="lg:col-span-2 bg-surface-100/80 rounded-xl p-4">
        ...
        <div className="min-h-screen py-3 sm:py-6 px-2 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-4 sm:mb-8">
                    ...
                    {/* Progress Bar */}
                    <div className="mt-4 bg-surface-100/50 rounded-xl p-4">
