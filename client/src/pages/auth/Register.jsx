    ...
    return (
        <div>
            <div className="text-center mb-8">
                <h1 className="text-2xl font-bold text-surface-800 mb-2">Create your account</h1>
                <p className="text-surface-500">Start your AI-powered interview practice</p>
            </div>
                    ...
                    {formData.password && (
                        ...
                        >
                            {passwordRequirements.map((req, index) => (
                                <div
                                    key={index}
                                    className={`flex items-center gap-2 text-sm ${req.met ? 'text-success-500' : 'text-surface-500'
                                        }`}
                                >
